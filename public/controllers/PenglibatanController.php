...
class TemplateSenaraiCrudController
{
    ...
    protected function loadRows(): void
    {
        $this->rows = [
            [
                ...
                'access_flag' => 1,
                'description' => 'Demonstration record for view, edit, and delete interactions.',
                'updated_at' => '27/03/2026 09:30 AM',
            ],
            [
                'id' => 2,
                'name' => 'Sample Beta',
                ...
                'group_name' => 'Operator',
                'access_flag' => 0,
                'description' => 'Example record with blocked access state for UI preview.',
                'updated_at' => '27/03/2026 09:45 AM',
            ],
            [
                'id' => 3,
                'name' => 'Sample Gamma',
                ...
                'group_name' => 'Reviewer',
                'access_flag' => 1,
                'description' => 'Sample row used to demonstrate modal and SweetAlert flow.',
                'updated_at' => '27/03/2026 10:00 AM',
            ],
        ];
    }
