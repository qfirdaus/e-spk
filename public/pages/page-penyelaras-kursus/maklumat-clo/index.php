<?php
  ...
  $pageHeading      = tr('maklumat_clo', 'Maklumat CLO'); 
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#maklumat-clo-tab" role="tab">
                  <i class="ri-book-read-line me-1"></i> <?= h(tr('tab_maklumat_clo','Maklumat CLO')) ?>
                </a>
              </li>             
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Maklumat CLO -->
              <div class="tab-pane fade show active" id="maklumat-clo-tab" role="tabpanel">
                <?php include __DIR__ . '/list-clo.php'; ?>
              </div>
