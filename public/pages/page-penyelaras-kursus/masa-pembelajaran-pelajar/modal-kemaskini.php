    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title"><i class="ri-edit-2-line me-1"></i>Kemaskini Maklumat SLT</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <form id="formKemaskiniSLT" action="" method="POST" autocomplete="off">
                <div class="modal-body">
                    <input type="hidden" name="txtidslt">
                    <input type="hidden" name="txtkursusid">
                    
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label fw-bold fs-6">Sesi</label>
                            <input type="text" name="txtsesi" class="form-control bg-light" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold fs-6">Kursus</label>
                            <input type="text" name="txtkursus" class="form-control bg-light" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="txtcontent" class="form-control" rows="3" placeholder="Masukkan Keterangan Course Content Outline (CCO)..." required></textarea>
                    </div>
                    
                    <div class="mb-4">
                        <label class="form-label fw-bold fs-6 text-dark">Kod CLO</label>
                        <select class="form-select" name="selectCLO" required>
                    ...
                    <hr class="my-4">
                    <h5 class="fw-bold text-primary mb-3">Teaching and Learning Activities (TLA)</h5>
                    ...
                    <div class="row mb-1 p-2 mx-0">
                        <div class="col-md-6 mb-2">
                            <label class="form-label fw-bold text-dark">NF2F (Guided)</label>
                            <input type="number" step="0.01" name="txtnf2f" class="form-control form-control-sm" placeholder="0">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label fw-bold text-dark">NF2F (Independent)</label>
