<form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
  <input type="hidden" name="icares_form" value="keluarga_penjaga">

  <div class="icares-address-layout">
    <div class="icares-address-nav" role="tablist" aria-label="<?= h(tr('tab_maklumat_penjaga', 'Maklumat Penjaga')) ?>">
      <button class="icares-address-nav__item active" id="penjaga-peribadi-tab" data-bs-toggle="pill" data-bs-target="#penjaga-peribadi-panel" type="button" role="tab" aria-controls="penjaga-peribadi-panel" aria-selected="true">
        <i class="ri-user-line"></i>
        <span><?= h(tr('profile_maklumat_peribadi', 'Maklumat Peribadi')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="penjaga-alamat-tab" data-bs-toggle="pill" data-bs-target="#penjaga-alamat-panel" type="button" role="tab" aria-controls="penjaga-alamat-panel" aria-selected="false">
        <i class="ri-home-4-line"></i>
        <span><?= h(tr('profile_alamat_tempat_tinggal', 'Alamat Tempat Tinggal')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="penjaga-pekerjaan-tab" data-bs-toggle="pill" data-bs-target="#penjaga-pekerjaan-panel" type="button" role="tab" aria-controls="penjaga-pekerjaan-panel" aria-selected="false">
        <i class="ri-briefcase-line"></i>
        <span><?= h(tr('profile_maklumat_pekerjaan', 'Maklumat Pekerjaan')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="penjaga-majikan-tab" data-bs-toggle="pill" data-bs-target="#penjaga-majikan-panel" type="button" role="tab" aria-controls="penjaga-majikan-panel" aria-selected="false">
    ...
    <div class="icares-address-content tab-content">
      <div class="tab-pane fade show active" id="penjaga-peribadi-panel" role="tabpanel" aria-labelledby="penjaga-peribadi-tab" tabindex="0">
    ...
    <div class="col-12 gx-4">
      ...
      <div class="mb-2 row align-items-center">
        <label class="col-sm-4 col-form-label text-nowrap"><?= h(tr('profile_nama_penjaga','Nama Penjaga')) ?></label>
        <div class="col-sm-8">
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" name="no_kad_pengenalan" class="form-control" value=" "  >
        </div>
      </div>
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" name="no_telefon" class="form-control" value=" "  >
        </div>
      </div>
      ...
      <div class="tab-pane fade" id="penjaga-alamat-panel" role="tabpanel" aria-labelledby="penjaga-alamat-tab" tabindex="0">
        <div class="icares-address-panel-header">
    ...
    <div class="col-12 gx-4">
      ...
      <div class="tab-pane fade" id="penjaga-pekerjaan-panel" role="tabpanel" aria-labelledby="penjaga-pekerjaan-tab" tabindex="0">
        <div class="icares-address-panel-header">
    ...
    <div class="col-12 gx-4">
      ...
      <div class="tab-pane fade" id="penjaga-majikan-panel" role="tabpanel" aria-labelledby="penjaga-majikan-tab" tabindex="0">
        <div class="icares-address-panel-header">
