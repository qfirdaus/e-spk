<?php
  ...
  $familyController = new KeluargaController();
  $dataFamilySAP = $familyController->getFamilySAPInfo();
  $dataFather = $familyController->getFatherInfo();
  $dataMother = $familyController->getMotherInfo();
  $lookupAll = $familyController->getAllLookup();
  $errorMessage = $familyController->getErrorMessage();
...
<div class="wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Profile Card with Tabs -->
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <!-- Tab Navigasi -->
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_family_tabs_label', 'Tab maklumat keluarga')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#maklumat-bapa-tab" role="tab">
                  <i class="ri-men-line me-1"></i> <?= h(tr('tab_maklumat_bapa','Maklumat Bapa')) ?>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#maklumat-ibu-tab" role="tab">
                  <i class="ri-women-line me-1"></i> <?= h(tr('tab_maklumat_ibu', 'Maklumat Ibu')) ?>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#maklumat-penjaga-tab" role="tab">
                  <i class="ri-user-heart-line me-1"></i> <?= h(tr('tab_maklumat_penjaga', 'Maklumat Penjaga')) ?>
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content p-4">
              ...
              <div class="tab-pane fade" id="maklumat-adik-beradik-tab" role="tabpanel">
  ...
  <script src="<?= base_url('assets/js/pages/hepa-data-keluarga.js?v=' . time()) ?>"></script>
