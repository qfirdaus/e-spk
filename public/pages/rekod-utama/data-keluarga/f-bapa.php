...
?>
<form id="form-bapa" method="post" enctype="multipart/form-data">
  <input type="hidden" name="icares_form" value="keluarga_bapa">

  <div class="icares-address-layout">
    <div class="icares-address-nav" role="tablist" aria-label="<?= h(tr('tab_maklumat_bapa','Maklumat Bapa')) ?>">
      <button class="icares-address-nav__item active" id="bapa-peribadi-tab" data-bs-toggle="pill" data-bs-target="#bapa-peribadi-panel" type="button" role="tab" aria-controls="bapa-peribadi-panel" aria-selected="true">
        <i class="ri-user-line"></i>
        <span><?= h(tr('profile_maklumat_peribadi', 'Maklumat Peribadi')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="bapa-alamat-tab" data-bs-toggle="pill" data-bs-target="#bapa-alamat-panel" type="button" role="tab" aria-controls="bapa-alamat-panel" aria-selected="false">
        <i class="ri-home-4-line"></i>
        <span><?= h(tr('profile_alamat_tempat_tinggal', 'Alamat Tempat Tinggal')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="bapa-pekerjaan-tab" data-bs-toggle="pill" data-bs-target="#bapa-pekerjaan-panel" type="button" role="tab" aria-controls="bapa-pekerjaan-panel" aria-selected="false">
        <i class="ri-briefcase-line"></i>
        <span><?= h(tr('profile_maklumat_pekerjaan', 'Maklumat Pekerjaan')) ?></span>
      </button>
      <button class="icares-address-nav__item" id="bapa-majikan-tab" data-bs-toggle="pill" data-bs-target="#bapa-majikan-panel" type="button" role="tab" aria-controls="bapa-majikan-panel" aria-selected="false">
    ...
    <div class="icares-address-content tab-content">
      <div class="tab-pane fade show active" id="bapa-peribadi-panel" role="tabpanel" aria-labelledby="bapa-peribadi-tab" tabindex="0">
    ...
    <div class="col-12 gx-4">
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" value="<?= ucwords(strtolower(h($dataFamilySAP['namabapa'] ?? ''))) ?>" readonly>          
          <input type="hidden" name="nama_bapa" class="form-control" value="<?= ucwords(strtolower(h($dataFamilySAP['namabapa'] ?? ''))) ?>">
        </div>                 
      </div>
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" value="<?= h($dataFamilySAP['nokpbapa'] ?? '') ?>" readonly>
          <input type="hidden" name="no_ic" class="form-control" value="<?= h($dataFamilySAP['nokpbapa'] ?? '') ?>" readonly>
        </div>
      </div>
      ...
      <div class="mb-2 row">
        ...
        <div class="col-sm-8">
          <input type="text" name="no_passport" class="form-control" value="<?= h($dataFather['passport_no'] ?? '') ?>" >
        </div>
      </div>         
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" name="no_telefon" class="form-control" value="<?= h($dataFamilySAP['nohp_bapa'] ?? '') ?>" readonly>
        </div>
      </div>
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="email" name="emel" class="form-control" value="<?= h($dataFather['email'] ?? '') ?>" >
        </div>
      </div>
        ...
        <div class="col-sm-8">
          <select name="status_kesihatan" class="form-select form-select-sm select2">
              ...
              <option value="<?= h($opt['OKU_code']) ?>"
                  <?= h($dataFather['health_status'] ?? '') == $opt['OKU_code'] ? 'selected' : '' ?>>
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <div class="upload-wrapper"> <?php if (!empty($dataFather['document_path'])): ?>
                  <div class="existing-file-section d-flex align-items-center gap-2">
                      <a href="<?= base_url(($dataFather['document_path']))?>" target="_blank" class="btn btn-sm btn-outline-warning">
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="number" name="bil_tanggungan" class="form-control" value="<?= h($dataFather['dependents_count'] ?? '') ?>" >
        </div>                 
      </div>
      ...
      <div class="mb-2 row align-items-center">
        ...
        <div class="col-sm-8">
          <input type="text" name="tahap_pendidikan" class="form-control" value="<?= h($dataFather['highest_education'] ?? '') ?>" >
        </div>
      </div>   
    </div>
        </div>
      ...
      <div class="tab-pane fade" id="bapa-alamat-panel" role="tabpanel" aria-labelledby="bapa-alamat-tab" tabindex="0">
        <div class="icares-address-panel-header">
        ...
        <div class="row">
          ...
          <div class="col-12 gx-4">
              ...
              <div class="col-sm-8">
                <select name="kategori_tempat_tinggal" class="form-select form-select-sm select2">
                    ...
                    <option value="<?= h($opt['residence_code']) ?>"
                        <?= h($dataFather['residence_category'] ?? '') == $opt['residence_code'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <input type="text" name="alamat_bapa1" class="form-control" value="<?= h($dataFather['address1'] ?? '') ?>" >
              </div>                 
            </div>
            ...
            <div class="mb-2 row">
              <div class="offset-sm-4 col-sm-8">
                <input type="text" name="alamat_bapa2" class="form-control" value="<?= h($dataFather['address2'] ?? '') ?>" >
              </div>
            </div>                        
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <input type="text" name="alamat_bapa3" class="form-control" value="<?= h($dataFather['address3'] ?? '') ?>" >
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <input type="text" name="alamat_bapa4" class="form-control" value="<?= h($dataFather['address4'] ?? '') ?>" >
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="negeri_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupNegeri as $opt): ?>
                    <option value="<?= h($opt['state_code']) ?>"
                        <?= h($dataFather['state_code'] ?? '') == $opt['state_code'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="negara_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupNegara as $opt): ?>
                    <option value="<?= h($opt['country_code']) ?>"
                        <?= h($dataFather['country_code'] ?? '') == $opt['country_code'] ? 'selected' : '' ?>>
      ...
      <div class="tab-pane fade" id="bapa-pekerjaan-panel" role="tabpanel" aria-labelledby="bapa-pekerjaan-tab" tabindex="0">
        <div class="icares-address-panel-header">
        ...
        <div class="row">
          ...
          <div class="col-12 gx-4">
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="status_pekerjaan_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupEmploymentStatus as $opt): ?>
                    <option value="<?= h($opt['emp_status_code']) ?>"
                        <?= h($dataFather['employment_status'] ?? '') == $opt['emp_status_code'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="sektor_pekerjaan_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupEmploymentSector as $opt): ?>
                    <option value="<?= h($opt['emp_sector_code']) ?>"
                        <?= h($dataFather['employment_sector'] ?? '') == $opt['emp_sector_code'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                  <select name="perkhidmatan_beruniform_bapa" class="form-select form-select-sm select2">
                    <option value="">-- Sila Pilih --</option>
                    <option value="YA" <?= h($dataFather['is_uniform_service'] ?? '') === 'YA' ? 'selected' : '' ?>>YA</option>
                    <option value="TIDAK" <?= h($dataFather['is_uniform_service'] ?? '') === 'TIDAK' ? 'selected' : '' ?>>TIDAK</option>
                  </select>     
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select id="select-jenis-uniform" name="jenis_perkhidmatan_beruniform_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupUniformService as $opt): ?>
                    <option value="<?= h($opt['service_code']) ?>"
                        <?= h($dataFather['uniform_service_type'] ?? '') == $opt['service_code'] ? 'selected' : '' ?>>
            ...
            <?php $isOthers = (h($dataFather['uniform_service_type'] ?? '') == 'OTH'); ?>
            <div id="section-uniform-lain" class="mb-2 row align-items-center" style="<?= $isOthers ? '' : 'display: none;' ?>">
              ...
              <div class="col-sm-8">
                <input type="text" id="perkhidmatan_beruniform_lain" name="perkhidmatan_beruniform_lain_bapa" class="form-control form-control-sm" value="<?= h($dataFather['uniform_service_others'] ?? '') ?>" placeholder="Contoh: Pengawal Keselamatan Swasta">
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="status_perkhidmatan_beruniform_bapa" class="form-select form-select-sm select2">
                    <option value=""><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupUniformServiceStatus as $opt): ?>
                    <option value="<?= h($opt['service_status_code']) ?>"
                        <?= h($dataFather['uniform_service_status'] ?? '') == $opt['service_status_code'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="pendapatan_bulanan_bapa" class="form-select form-select-sm select2">
                    <option value="0.00"><?= h(tr('sila_pilih', 'Sila Pilih')) ?></option>
                    <?php foreach ($lookupSalaryRange as $opt): ?>
                    <option value="<?= h($opt['value']) ?>"
                        <?= h($dataFather['gross_monthly_income'] ?? '') == $opt['value'] ? 'selected' : '' ?>>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <div class="upload-wrapper">
                  <?php if (!empty($dataFather['income_proof_docpath'])): ?>
                    <div class="existing-file-section d-flex align-items-center gap-2">
                        <a href="<?= base_url(($dataFather['income_proof_docpath']))?>" target="_blank" class="btn btn-sm btn-outline-warning">
      ...
      <div class="tab-pane fade" id="bapa-majikan-panel" role="tabpanel" aria-labelledby="bapa-majikan-tab" tabindex="0">
        <div class="icares-address-panel-header">
        ...
        <div class="row">
          ...
          <div class="col-12 gx-4">
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <textarea type="text" name="majikan" class="form-control"><?= h($dataFather['employer_name'] ?? '') ?></textarea>
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              <label class="col-sm-4 col-form-label text-nowrap"><?= h(tr('profile_alamat1','Alamat')) ?></label>
              <div class="col-sm-8">
                <input type="text" name="alamat_majikan1" class="form-control" value="<?= h($dataFather['employer_address1'] ?? '') ?>" >
              </div>                 
            </div>
            ...
            <div class="mb-2 row">
              <div class="offset-sm-4 col-sm-8">
                <input type="text" name="alamat_majikan2" class="form-control" value="<?= h($dataFather['employer_address2'] ?? '') ?>" >
              </div>
            </div>                        
            ...
            <div class="mb-2 row align-items-center">
              <label class="col-sm-4 col-form-label text-nowrap"><?= h(tr('profile_poskod','Poskod')) ?></label>
              <div class="col-sm-8">
                <input type="text" name="alamat_majikan3" class="form-control" value="<?= h($dataFather['employer_address3'] ?? '') ?>" >
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              <label class="col-sm-4 col-form-label text-nowrap"><?= h(tr('profile_bandar','Bandar')) ?></label>
              <div class="col-sm-8">
                <input type="text" name="alamat_majikan4" class="form-control" value="<?= h($dataFather['employer_address4'] ?? '') ?>" >
              </div>
            </div>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="negeri_majikan" class="form-select form-select-sm select2">
                    ...
                    <?php foreach ($lookupNegeri as $opt): ?>
                    <option value="<?= h($opt['state_code']) ?>"
                        <?= h($dataFather['employer_state_code'] ?? '') == $opt['state_code'] ? 'selected' : '' ?>>
                        <?= h(strtoupper($opt['state'])) ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-2 row align-items-center">
              ...
              <div class="col-sm-8">
                <select name="negara_majikan" class="form-select form-select-sm select2">
                    ...
                    <?php foreach ($lookupNegara as $opt): ?>
                    <option value="<?= h($opt['country_code']) ?>"
                        <?= h($dataFather['employer_country_code'] ?? '') == $opt['country_code'] ? 'selected' : '' ?>>
                        <?= h(strtoupper($opt['country'])) ?>
                    </option>
                    <?php endforeach; ?>
                </select>
