<?php
  require_once __DIR__ . '/../../../../controllers/PemetaanKursusPLOController.php'; 
  $controller = new PemetaanKursusPLOController();
...
<div class="konvo-tab-card p-4 mb-4 shadow-sm rounded-3">
    <div class="icares-address-panel-header mb-3">
        <h5 class="text-h5 fw-bold text-primary m-0">Carian Pemetaan</h5>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="icares-address-panel-header">
            <h5 class="text-h5 fw-bold text-primary m-0">Pemetaan Kursus dan PLO</h5>
        </div>   
    </div>
    
    <div class="w-100 mt-3">
        <table id="tablePemetaan" class="table table-sm table-bordered align-middle table-hover w-100">
