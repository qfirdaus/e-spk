<?php
  ...
  $pageHeading      = tr('pemetaan_kursus_plo', 'Pemetaan Kursus dan PLO'); 
...
<body data-topbar-color="<?= h($_SESSION['theme.topbar'] ?? 'light') ?>" data-menu-color="<?= h($_SESSION['theme.sidebar'] ?? 'dark') ?>" data-layout="vertical" class="loading">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#pemetaan-tab" role="tab">
                  <i class="ri-table-2 me-1"></i> <?= h(tr('tab_pemetaan','Pemetaan Kursus & PLO')) ?>
                </a>
              </li>            
            </ul>
  ...
  <script src="<?= base_url('assets/js/pages/spk-pemetaan-kursus.js?v=' . time()) ?>"></script> 
