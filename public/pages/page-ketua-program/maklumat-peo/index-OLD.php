    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span><?= $lang['TTL-MAKLUMAT-PEO'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="dt-responsive">
                                                            ...
                                                            <table id="order-table"
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        <th><?= $lang['COL-KOD-PEO'] ?></th>
                                                                        <th><?= $lang['COL-KETERANGAN-PEO'] ?></th>
                                                                        <th><?= $lang['COL-TARIKH-SENAT'] ?></th>
                                                                        <th><?= $lang['COL-SENARAI-PLO'] ?></th>
                                                                        <th></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    ...
                                                                    while ($result = @sybase_fetch_array($sql_result_peo_list)) { 
                                                                        $tarikhsenat = date("d-M-Y", strtotime($result["tarikh_senat"]));
                                                                        ...
                                                                        $sql_result_plo = @sybase_query($sql_plo, $connection);
                                                                        ?>
                                                                        <tr>
                                                                            <td><?= $result["kod_peo"] ?></td>
                                                                            <td><?= $result["keterangan_bm"] ?></td>
                                                                            <td><?= $tarikhsenat ?></td>
                                                                            <td>
                                                                                <?php
                                                                                $strpeo = "";
                                                                                while ($result_plo = @sybase_fetch_array($sql_result_plo)) {
                                                                                    $strpeo = $strpeo . '<a class="table-a" title="' . $result_plo['keterangan_bm'] . '">' . $result_plo['kod_plo'] . '</a>, ';
                                                                                }

                                                                                echo substr($strpeo, 0, -3);
                                                                                ?>
                                                                            </td>
                                                                            <td width="100px">
                                                                    <center>
                                                                        <div class="list-actions">
                                                                            <form id="deleteForm<?= $i ?>" action="sql_delete_peo.php" method="POST">
                                                                                <input type="hidden" name="txtidpeo" value="<?= $result["id_peo"]; ?>"> 
                                                                            </form>

                                                                            <?php
                                                                            $tarikhsenat = date("Y-m-d", strtotime($tarikhsenat));
                                                                            ?>
                                                                            ...
                                                                            <button class="button-round" type="button" name="btnKemaskini" id="btnKemaskini" data-toggle="modal" data-target="#kemaskini" 
                                                                                    ...
                                                                                    data-program="<?= $row_program["program"]?>"
                                                                                    data-idpeo="<?= $result["id_peo"] ?>"
                                                                                    data-kodpeo="<?= $result["kod_peo"] ?>"
                                                                                    data-keteranganbm="<?= $result["keterangan_bm"] ?>"
                                                                                    data-tarikhsenat="<?= $tarikhsenat ?>"
        ...
        <script>
                                                                                ...
                                                                                $(document).ready(function () {
                                                                                    document.getElementById('selectPengajian').value = '<?= $_SESSION["pengajianpeo"] ?>';
                                                                                    document.getElementById('selectSesi').value = '<?= $_SESSION["sesipeo"] ?>';
                                                                                    document.getElementById('selectProgram').value = '<?= $_SESSION["programpeo"] ?>';
                                                                                });
                                                                                ...
                                                                                $(document).on("click", "#btnKemaskini", function () {
                                                                                    ...
                                                                                    var idpeo = $(this).data('idpeo');
                                                                                    $("#kemaskini .modal-body #txtidpeo").val(idpeo);

                                                                                    var kodpeo = $(this).data('kodpeo');
                                                                                    $("#kemaskini .modal-body #txtkodpeo").val(kodpeo);

                                                                                    var keteranganbm = $(this).data('keteranganbm');
                                                                                    $("#kemaskini .modal-body #txtketeranganpeo").val(keteranganbm);

                                                                                    var tarikhsenat = $(this).data('tarikhsenat');
                                                                                    $("#kemaskini .modal-body #txttarikhsenat").val(tarikhsenat);
