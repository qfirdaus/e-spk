    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= $lang['TTL-TAMBAH-PEO']  ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form autocomplete="off" action="sql_add_peo.php" method="POST">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 co2l-lg-12 col-xl-12">						
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control" name="selectkodpeo" id="selectkodpeo">
