...
/*
  ...
  $sql = "insert into spk_tlogin(id_staf, nama, username, password, id_role, jabatan, created_by, created_date) values ('$nostaf','$nama','$nostaf', '$nokp', $idrole, '$jabatan', '$created_by', GETDATE())";
  $result = @sybase_query($sql, $connection);
  // echo $sql;
  if ($result) {
  header('Location: ../penyelaras-kursus-clo?action=save-success');
  } else {
  header('Location: ../penyelaras-kursus-clo?action=save-fail');
  } */
?>