<?php
require_once __DIR__ . '/../../../controllers/MaklumatKursusProgramController.php';

$controller = new MaklumatKursusProgramController();
...
<div class="icares-address-content">
    <div class="tab-pane show active">
      ...
      <form id="form-maklumat-kursus-program" method="POST" action="">
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="col-md-6 gx-4">
                  ...
                  <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-8">
                      <select class="form-select form-select-sm select2" onchange="this.form.submit()" name="selectPengajianKursus" id="selectPengajianKursus">
                  ...
                  <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-8"> 
                      <select class="form-select form-select-sm select2" onchange="this.form.submit()" name="selectSesiKursus" id="selectSesiKursus">
                  ...
                  <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-8"> 
                      <select class="form-select form-select-sm select2" onchange="this.form.submit()" name="selectProgramKursus" id="selectProgramKursus">
...
<div class="konvo-tab-card p-3 mb-4">
  <div class="icares-address-panel-header">
    <h5 class="text-h5"><?= h(tr('senarai_kursus','Senarai Kursus')) ?></h5>
    ...
    <div class="list-actions" style="float: right; margin-bottom:10px;">
        ...
        <button class="btn btn-sm btn-outline-info rounded-3" type="button" name="btnTambah" id="btnTambah" 
                ...
                title="<?= h(tr('tambah_kursus_baru', 'Tambah Kursus Baru')) ?>">
  ...
  <div class="table-responsive dt-standard">
    ...
    <thead>
      <tr>
        ...
        <th class="small w-30"><?= h(tr('kod_kursus', 'Kod Kursus')) ?></th>
        <th class="small w-15"><?= h(tr('nama_kursus', 'Nama Kursus')) ?></th>
        <th class="small w-12"><?= h(tr('kategori_kursus', 'Kategori Kursus')) ?></th>
        <th class="small w-12"><?= h(tr('penyelaras', 'Penyelaras')) ?></th>
    ...
    <tbody>     
      <?php 
        $list_dataKursus = $data['list_kursus_program'] ?? [];

        // Semak jika array kosong
        if (empty($list_dataKursus)): 
      ?>
        <tr>
      ...
      <?php 
            ...
            foreach ($list_dataKursus as $i => $row):  
                $rowJson = json_encode($row, JSON_HEX_APOS | JSON_HEX_QUOT); 
                $idKursus = $row['id_kursus'] ?? '';
                      ?>
        <tr data-id="<?= $idKursus ?>" data-row='<?= $rowJson ?>'>
            ...
            <td>
                <form action="" method="POST">
                    <input name="txtIdKursus" type="hidden" value="<?= h($idKursus ?? '') ?>"/>
            ...
            <td>
              <form action="" method="POST" id="form_<?= h($idKursus) ?>">
                  <div class="row g-2 align-items-center">
                      ...
                      <div class="col-sm-2"> 
                          <button class="btn btn-sm btn-outline-secondary" 
                                  type="button" 
                                  onclick="resetPenyelaras('<?= h($idKursus) ?>')"
                                  title="Reset">
