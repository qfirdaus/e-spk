...
$sql = "select * from v006_spk where tahap_pengajian='" . $_SESSION["pengajiankursus"] . "' AND fakulti_singkatan = '" . $_SESSION['ptj'] . "' AND id_program = '" . $_SESSION['programkursus'] . "' order by program";
$sql_result = @sybase_query($sql, $connection);
$row_program = @sybase_fetch_array($sql_result);
...
where  a.term_pengajian='" . $_SESSION["sesikursus"] . "' and a.kod_jabatan='" . $_SESSION['ptj'] . "' and a.kod_program='" . $_SESSION['programkursus'] . "' and a.program_universiti='$programuniversiti' order by kod_kursus";
$sql_result_subject_list = @sybase_query($sql, $connection);
