    ...
    <body>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="sql.php" method="POST">
                                            <div class="form-group col-sm-8 row">
                                                <label for="program" class="col-sm-2 col-form-label"><?= $lang['LBL-PROGRAM'] ?></label>
                                                <div class="col-sm-10">
                                                            ...
                                                            <table id="order-table"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($result = @sybase_fetch_array($sql_result_subject_list)) {
                                                                        $complete = "<span style='color:red;'><i class='ik ik-x-circle'></i></span>";
                                                                        ?>
                                                                        <tr>
                                                                            <td><?php
                                                                                if ($result["kategori_kursus"] != NULL && $result["penyelaras_kursus"] != NULL)
                                                                                    $complete = "<span style='color:green; '> <i class='ik ik-check-circle'> </i></span>";
                                                                                echo $complete;
                                                                                ?></td>
        ...
        <script>
                                                                                        $(document).ready(function () {
                                                                                            ...
                                                                                            document.getElementById('selectProgram').value = '<?= $_SESSION["programkursus"] ?>';
                                                                                        });
