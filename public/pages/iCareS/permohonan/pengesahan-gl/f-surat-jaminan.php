                ...
                <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
                  <input type="hidden" name="icares_form" value="permohonan_pengesahan_gl">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-md-6 gx-4">
                          ...
                          <div class="mb-2 row align-items-center">
                            <div class="col-sm-4">
                                ...
                                aria-label="<?= h(tr('profile_akaun_bank','Dokumen Sokongan')) ?>" data-bs-original-title="<?= h(tr('profile_dokumen_akaun_note','Sila sertakan Surat Rujukan / Kad / Buku Temujanji / Rawatan dalam format JPG/JPEG/PDF, maks 5MB')) ?>"></i>
                            </div>
                            <div class="col-sm-8">
