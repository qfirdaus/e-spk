        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#maklumat-gl-tab" role="tab">
                  <i class="ri-briefcase-line me-1"></i> <?= h(tr('tab_maklumat_gl', 'Maklumat Surat Jaminan')) ?>
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 3: Maklumat Surat Jaminan -->
              <div class="tab-pane fade show" id="maklumat-gl-tab" role="tabpanel">
                <?php  include __DIR__ . '/f-surat-jaminan.php'; ?>
              </div> 
