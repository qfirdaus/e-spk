<?php
  ...
  $NEED_SELECT2    = false;
  $pageHeading     = tr('page_heading_bantuan_kes_khas', 'Bantuan Kes Khas');
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#maklumat-bantuan-tab" role="tab">
                  <i class="ri-briefcase-line me-1"></i> <?= h(tr('tab_maklumat_bantuan', 'Maklumat Bantuan')) ?>
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content p-4">
              ...
              <div class="tab-pane fade show" id="maklumat-bantuan-tab" role="tabpanel">
                <?php  include __DIR__ . '/f-bantuan.php'; ?>
              </div> 
