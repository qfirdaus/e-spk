                ...
                <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
                  <input type="hidden" name="icares_form" value="permohonan_bantuan_kes_khas">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-md-6 gx-4">
                          ...
                          <div class="mb-2 row align-items-center">
                            <div class="col-sm-4">
                                ...
                                aria-label="<?= h(tr('profile_akaun_bank','Dokumen Sokongan')) ?>" data-bs-original-title="<?= h(tr('profile_dokumen_akaun_note','Sila sertakan Laporan Polis / Gambar / Dokumen Rasmi Berkaitan dalam format JPG/JPEG/PDF, maks 5MB')) ?>"></i>
                            </div>
                            <div class="col-sm-8">
                                <?php for ($i=0; $i<5; $i++) { ?>
                                <div class="mb-2">
                                  <label class="col-form-label text-nowrap"><?= h(tr('profile_dokumen','Dokumen').sprintf(' %d', $i+1)) ?></label>
                                  <input type="file" name="dokumen[<?= $i ?>]" class="form-control" accept=".jpg, .jpeg, .pdf" onchange="checkFileSize(this)" />
