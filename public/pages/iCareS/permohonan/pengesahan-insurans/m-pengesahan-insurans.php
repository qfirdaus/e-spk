    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <?php
          ...
          $categoryUser = strtoupper(trim((string)($profileView['categoryUser'] ?? $profileView['f_categoryUser'] ?? $_SESSION['f_categoryUser'] ?? $_SESSION['user']['f_categoryUser'] ?? $_SESSION['auth_type'] ?? '')));
          ...
          <div class="profile-hero">
            <div class="profile-hero-shell">
              ...
              <div class="profile-hero-main">
                <div class="profile-hero-eyebrow"><?= h(tr('profile_student_card_label', 'Profil Pelajar')) ?></div>
          ...
          <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#penglibatan-program-tab" role="tab">
                <i class="ri-shield-check-line me-1"></i> <?= h(tr('tab_maklumat_penerima','Maklumat Insurans')) ?>
              </a>
            </li>
            <li class="nav-item">
          ...
          <div class="tab-content p-4">
            ...
            <div class="tab-pane fade show active" id="maklumat-peribadi-tab" role="tabpanel">
              <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
                <input type="hidden" name="icares_form" value="permohonan_pengesahan_insurans_peribadi">
                <div class="row">
            ...
            <div class="tab-pane fade" id="penglibatan-program-tab" role="tabpanel">
              ...
              <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
                <input type="hidden" name="icares_form" value="permohonan_pengesahan_insurans_dokumen">
                <div class="row ">
                  <div class="col-12 col-md-8">                  
                    ...
                    <div class="col-sm-4">
                        ...
                        <?= h(tr('profile_dokumen_sokongan_note','(Dokumen Insurans dalam format JPG/JPEG/PDF, maks 5MB)')) ?>
                        </small>
                    </div>
            ...
            <!-- Tab 3: Perakuan Pemohon -->
            <div class="tab-pane fade" id="perakuan-pemohon-tab" role="tabpanel">
              <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
              <input type="hidden" name="icares_form" value="permohonan_pengesahan_insurans_perakuan">
              <div class="card-text">
                <ul style="list-style: none; padding: 0;">
                  <li>1&#41;<span style="margin-left: 10px;"><?= h(tr('icares_declaration_no_disciplinary','Saya mengaku bahawasannya saya tidak pernah dikenakan tindakan tatatertib sepanjang pengajian saya di UPNM.')) ?></span></li>
                  <li>2&#41;<span style="margin-left: 10px;"><?= h(tr('icares_declaration_information_true','Adalah dengan ini saya mengaku bahawa maklumat yang diberikan di atas adalah benar.')) ?></span><br>
              ...
              <div class="form-check" style="margin-left: 10px;">
                ...
                <label class="form-check-label" for="consentCheck">
                  <?= h(tr('icares_declaration_agree','Setuju')) ?>
                </label>
              </div>
              <br> 
              <p class="mb-0 fw-semibold" style="margin-left: 10px;"><?= h(tr('icares_declaration_name','Nama')) ?>: <?= h($_SESSION['user.name'] ?? $namaPenuh ?? '') ?></p>
