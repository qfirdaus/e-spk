<?php
  ...
  $pageHeading     = tr('tetapan_tarikh', 'Tetapan Tarikh');
...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tetapan-tarikh-tab" role="tab">
                  <i class="ri-calendar-todo-line me-1"></i> <?= h(tr('tab_tarikh-permohonan','Tetapan Tarikh Permohonan')) ?>
                </a>
              </li>
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Tetapan Tarikh Permohonan -->
              <div class="tab-pane fade show active" id="tetapan-tarikh-tab" role="tabpanel">
                <div id="tetapan-tarikh-container">
  ...
  <script src="<?= base_url('assets/js/pages/istar-konfigurasi.js?v=' . time()) ?>"></script> 
  <link rel="stylesheet" href="<?= base_url('assets/css/pages/istar-konfigurasi.css') ?>">
