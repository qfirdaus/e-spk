<?php
$tempohProgram = isset($tempohProgram) ? (string)$tempohProgram : '';
$pngkSemasa = isset($pngkSemasa) ? (string)$pngkSemasa : '';
$pngkAkhir = isset($pngkAkhir) ? (string)$pngkAkhir : '';
$gredKursusPsm = isset($gredKursusPsm) ? (string)$gredKursusPsm : '';
$bilAnugerahDekan = isset($bilAnugerahDekan) ? (string)$bilAnugerahDekan : '';
?>
                <form method="post" enctype="multipart/form-data" action="<?= base_url('actions/profile-update.php') ?>">
                  <input type="hidden" name="icares_form" value="istar_hari_inovasi_peribadi">
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
