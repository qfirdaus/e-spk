                ...
                <div class="d-flex justify-content-end mt-3" >
                    <button type="button" class="btn btn-primary px-4" id="btn-submit-pelajar-diraja">
                    ...
                    <tbody>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="selectAll-pelajar-diraja-program" />
                                <label class="form-check-label" for="selectAll-pelajar-diraja-program"></label>
                            </div>                            
                        </td>
                        <td>1</td>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="selectAll-pelajar-diraja-jawatan" />
                                <label class="form-check-label" for="selectAll-pelajar-diraja-jawatan"></label>
                            </div>                            
                        </td>
                        <td>2</td>
                ...
                <!-- <div class="d-flex justify-content-end mt-3" >
                    <button type="button" class="btn btn-primary px-4" id="btn-submit-pelajar-diraja-calon">
