    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span><?= $lang['TTL-MAKLUMAT-KAEDAH-PENGAJARAN'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-sm-12">
                                <div class="card" >
                                    <div class="card-header d-block">
                                        <h3><?= $lang['PANEL-KAEDAH-PENGAJARAN'] ?></h3>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="list-actions" style="float: right; margin-bottom:10px;">
                                                    <button class="button-round" type="button" name="btnTambah" id="btnTambah" data-toggle="modal" data-target="#tambah" 
                                                            title="<?= $lang['TTP-TAMBAH-KAEDAH-PENGAJARAN'] ?>"><i class="ik ik-plus text-primary"></i></button>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="dt-responsive">
                                                            ...
                                                            <table id="order-table"
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        <th><?= $lang['COL-BIL'] ?></th>
                                                                        <th><?= $lang['COL-KAEDAH-PENGAJARAN'] ?></th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($result = @sybase_fetch_array($sql_result)) {
                                                                        ...
                                                                        <tr>
                                                                            <td><?= $i ?></td>
                                                                            <td><?= $result["kaedah_pengajaran"] ?></td>
                                                                            <td><?= $tarikhkemaskini ?></td>
                                                                            <td width="100px">
                                                                    <center>
                                                                        <div class="list-actions">
                                                                            <form id="deleteForm<?= $i ?>" action="sql_delete_kaedah_pengajaran.php" method="POST">
                                                                                <input type="hidden" name="txtidkaedah_pengajaran" value="<?= $result["id_kaedah_pengajaran"]; ?>"> 
                                                                            </form>

                                                                            <button class="button-round" type="button" name="btnKemaskini" id="btnKemaskini" data-toggle="modal" data-target="#kemaskini" 
                                                                                    data-idkaedah_pengajaran="<?= $result['id_kaedah_pengajaran'] ?>"   
                                                                                    data-kaedah_pengajaran="<?= $result['kaedah_pengajaran'] ?>"  
        ...
        <script>
                                                                            ...
                                                                            $(document).on("click", "#btnKemaskini", function () {
                                                                                var idkaedah_pengajaran = $(this).data('idkaedah_pengajaran');
                                                                                $("#kemaskini .modal-body #txtidkaedah_pengajaran").val(idkaedah_pengajaran);

                                                                                var kaedah_pengajaran = $(this).data('kaedah_pengajaran');
                                                                                $("#kemaskini .modal-body #txtkaedah_pengajaran").val(kaedah_pengajaran);
