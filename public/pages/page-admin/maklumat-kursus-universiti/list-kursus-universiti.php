...
<div class="card border border-light-subtle shadow-none p-4 mb-4 rounded-3 bg-white">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="icares-address-panel-header">
          <h5 class="text-h5 fw-bold text-primary m-0">
            <?= h(tr('senarai_kursus_universiti','Senarai Kursus Universiti')) ?>
          </h5>
      </div>
    ...
    <div class="w-100 mt-3">
      ...
      <thead>
        <tr>
          <th class="col-bil text-center" width="5%">No</th>
          <th class="small" width="10%"><?= h(tr('COL-KOD-KURSUS', 'Kod Kursus')) ?></th>
          <th class="small" width="30%"><?= h(tr('COL-NAMA-KURSUS', 'Nama Kursus')) ?></th>
          <th class="small"><?= h(tr('COL-KATEGORI-KURSUS', 'Kategori Kursus')) ?></th>
          <th class="small" width="30%"><?= h(tr('COL-PENYELARAS', 'Penyelaras')) ?></th>
        </tr>
      </thead>
      ...
      <tbody>     
        ...
        ?>
          <tr>
              ...
              <td class="fw-bold text-primary"><?= h($row['kod_kursus'] ?? '') ?></td>
              ...
              <td>
                  <form action="" method="POST">
                      ...
                      <select class="form-select form-select-sm select2" name="selectKategoriKursus" onchange="this.form.submit()">
              ...
              <td>
                <form action="" method="POST" id="form_<?= h($row['id_kursus']) ?>">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-sm-2"> 
                            <button class="btn btn-sm btn-outline-danger btn-reset-penyelaras flex-shrink-0" type="button" 
