<?php
  ...
  $pageHeading     = tr('maklumat_kursus_universiti', 'Maklumat Kursus Universiti');
...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#maklumat-kursus-universiti-tab" role="tab">
                  <i class="ri-calendar-todo-line me-1"></i> <?= h(tr('tab_maklumat_kursus_universiti','Maklumat Kursus Universiti')) ?>
                </a>
              </li>             
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Maklumat Kursus Universiti -->
              <div class="tab-pane fade show active" id="maklumat-kursus-universiti-tab" role="tabpanel">
                <?php include __DIR__ . '/list-kursus-universiti.php'; ?>
              </div>
  ...
  <script src="<?= base_url('assets/js/pages/spk-maklumat-kursus-universiti.js?v=' . time()) ?>" defer></script> 
