<?php
  ...
  $pageHeading     = tr('TTL-MAKLUMAT-LOC', 'Kluster Hasil Pembelajaran');
...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#kluster-hasil-pembelajaran-tab" role="tab">
                  <i class="ri-calendar-todo-line me-1"></i> <?= h(tr('TTL-MAKLUMAT-LOC','Kluster Hasil Pembelajaran')) ?>
                </a>
              </li>             
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <div class="tab-pane fade show active" id="kluster-hasil-pembelajaran-tab" role="tabpanel">
                <?php include __DIR__ . '/list-hasil-pembelajaran.php'; ?>
              </div>
  ...
  <script src="<?= base_url('assets/js/pages/spk-kluster-hasil-pembelajaran.js?v=' . time()) ?>" defer></script> 
