...
<div class="konvo-tab-card p-3 mb-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div class="icares-address-panel-header">
      <h5 class="text-h5 fw-bold text-primary m-0">
        <?= h(tr('PANEL-PENILAIAN','Senarai Penilaian')) ?>
      </h5>
    </div>
  ...
  <div class="w-100 mt-3">
    <table id="dataAssessmentDT" class="table table-sm table-bordered align-middle table-hover w-100">
    <thead>
      <tr>
        <th width="5%" class="col-bil text-center"><?= h(tr('COL-BIL', 'No')) ?></th>
        <th class="small "><?= h(tr('COL-PENILAIAN', 'Penilaian')) ?></th>
    ...
    <tbody>     
      ...
      ?>
        <tr>
            ...
            <td class="fw-bold text-primary"><?= h($row['penilaian'] ?? '') ?></td>
