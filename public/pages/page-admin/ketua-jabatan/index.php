<?php
  ...
  $pageHeading     = tr('TTL-MAKLUMAT-KETUA-JABATAN', 'Maklumat Ketua Jabatan');
...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#ketua-jabatan-tab" role="tab">
                  <i class="ri-calendar-todo-line me-1"></i> <?= h(tr('TTL-MAKLUMAT-KETUA-JABATAN','Maklumat Ketua Jabatan')) ?>
                </a>
              </li>             
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Ketua Jabatan -->
              <div class="tab-pane fade show active" id="ketua-jabatan-tab" role="tabpanel">
                <?php include __DIR__ . '/list-ketua-jabatan.php'; ?>
              </div>
  ...
  <script src="<?= base_url('assets/js/pages/spk-ketua-jabatan.js?v=' . time()) ?>" defer></script> 
