                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span><?= $lang['TTL-MAKLUMAT-LOC'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="list-actions" style="float: right; margin-bottom:10px;">
                                                    <button class="button-round" type="button" name="btnTambah" id="btnTambah" data-toggle="modal" data-target="#tambah" 
                                                            title="<?= $lang['TTP-TAMBAH-LOC'] ?>"><i class="ik ik-plus text-primary"></i></button>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <center>
                                                                        <div class="list-actions">
                                                                            <form id="deleteForm<?= $i ?>" action="sql_delete_loc.php" method="POST">
                                                                                <input type="hidden" name="txtidloc" value="<?= $result["id_loc"]; ?>"> 
                                                                            </form>

                                                                            <button class="button-round" type="button" name="btnKemaskini" id="btnKemaskini" data-toggle="modal" data-target="#kemaskini" 
                                                                                    data-idloc="<?= $result['id_loc'] ?>"   
                                                                                    data-loc="<?= $result['loc'] ?>"  
