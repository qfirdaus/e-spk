...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#maklumat-plo-tab" role="tab">
                  <i class="ri-calendar-todo-line me-1"></i> <?= h(tr('tab_maklumat_plo','Maklumat PLO')) ?>
                </a>
              </li>             
            </ul>
  ...
  <script src="<?= base_url('assets/js/pages/spk-maklumat-plo.js?v=' . time()) ?>" defer></script> 
