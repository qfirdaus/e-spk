...
//Retrieve PLO List
$sql = "select * from spk_tplo where status_aktif=1 and kod_sesi='" .$_SESSION["sesiplo"]. "' and program_universiti='$programuniversiti'";// and kod_program='".$_SESSION["programplo"]."'";
