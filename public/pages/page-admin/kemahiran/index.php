                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span><?= $lang['TTL-MAKLUMAT-KEMAHIRAN'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="list-actions" style="float: right; margin-bottom:10px;">
                                                    <button class="button-round" type="button" name="btnTambah" id="btnTambah" data-toggle="modal" data-target="#tambah" 
                                                            title="<?= $lang['TTP-TAMBAH-KEMAHIRAN'] ?>"><i class="ik ik-plus text-primary"></i></button>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body">
                                                            ...
                                                            <table id="order-table"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($result = @sybase_fetch_array($sql_result)) {
                                                                        ...
                                                                        <tr>
                                                                            <td><?= $i ?></td>
                                                                            <td><?= $result["kemahiran"] ?></td>
                                                                            <td><?= $tarikhkemaskini ?></td>
                                                                            <td width="100px">
                                                                    <center>
                                                                        <div class="list-actions">
                                                                            <form id="deleteForm<?= $i ?>" action="sql_delete_kemahiran.php" method="POST">
                                                                                <input type="hidden" name="txtidkemahiran" value="<?= $result["id_kemahiran"]; ?>"> 
                                                                            </form>

                                                                            <button class="button-round" type="button" name="btnKemaskini" id="btnKemaskini" data-toggle="modal" data-target="#kemaskini" 
                                                                                    data-idkemahiran="<?= $result['id_kemahiran'] ?>"   
                                                                                    data-kemahiran="<?= $result['kemahiran'] ?>"  
