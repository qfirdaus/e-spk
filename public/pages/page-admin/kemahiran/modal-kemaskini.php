    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= $lang['TTL-KEMASKINI-KEMAHIRAN']  ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form autocomplete="off" action="sql_update_kemahiran.php" method="POST">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 co2l-lg-12 col-xl-12">		                                       
                                        <div class="form-group row">
                                            <input name="txtidkemahiran" id="txtidkemahiran" type="hidden" class="form-control" autocomplete="off">
                                            <label class="col-sm-3 col-form-label"><?= $lang['LBL-KEMAHIRAN']?></label>
                                            <div class="col-sm-5">
                                                <input name="txtkemahiran" id="txtkemahiran" type="text" class="form-control" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>                                                                                             
                                </div>                          
