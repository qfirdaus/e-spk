<?php
  ...
  $pageHeading     = tr('TTL-MAKLUMAT-KETUA-PROGRAM', 'Maklumat Ketua Program');
...
<body
        ...
        <div class="container-fluid">
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Ketua Program -->
              <div class="tab-pane fade show active" id="ketua-program-tab" role="tabpanel">
                <?php include __DIR__ . '/list-ketua-program.php'; ?>
              </div>
  ...
  <script src="<?= base_url('assets/js/pages/spk-ketua-program.js?v=' . time()) ?>" defer></script> 
