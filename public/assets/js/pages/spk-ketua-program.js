$(document).ready(function () {
    ...
    if ($('#dataKetuaProgramDT').length > 0) {
        if (typeof $.fn.DataTable !== 'undefined') {
            $('#dataKetuaProgramDT').DataTable({
                responsive: false, 
                scrollX: false,     
                autoWidth: false,
                ordering: false,   
...
// submit Ketua Program baharu
const btnTambahKetuaProgram = document.getElementById('btnTambahKetuaProgram');
if (btnTambahKetuaProgram) {
    btnTambahKetuaProgram.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            text: "Anda mahu menyimpan maklumat ketua program baharu ini?",
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                hiddenInput.name = 'btnTambahKetuaProgram';
                hiddenInput.value = '1';
                form.appendChild(hiddenInput);

                submitHeadProgramme(form);
            }
        });
    });
}

function submitHeadProgramme(formElement) {
    const formData = new FormData(formElement);
    const controllerUrl = base_url + 'pages/page-admin/ketua-program/submit-head-programme.php';
