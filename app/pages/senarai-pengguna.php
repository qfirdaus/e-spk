            ...
            try {
              ...
              dtInstance = $('#userDT').DataTable({
                ...
                rowCallback: function(row, data, displayIndex){
                  ...
                  $row.removeClass('row-group-adm-sa row-group-adm-hr');
                  if (groupId === CONFIG.GROUP_IDS.ADMIN_SA) {
                    $row.addClass('row-group-adm-sa');
                  } else if (groupId === CONFIG.GROUP_IDS.ADMIN_HR) {
                    $row.addClass('row-group-adm-hr');
                  }
                },
