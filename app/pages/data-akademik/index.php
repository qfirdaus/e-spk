        ...
        <!-- Profile Card with Tabs -->
          ...
          <div class="card border-0 shadow-sm profile-card">
            ...
            <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#maklumat-akademik-tab" role="tab">
                  <i class="ri-login-box-line me-1"></i> <?= h(tr('tab_maklumat_akademik','Maklumat Akademik')) ?>
                </a>
              </li>
            </ul>
            ...
            <div class="tab-content p-4">
              ...
              <!-- Tab 1: Maklumat Akademik -->
              <div class="tab-pane fade show active" id="maklumat-akademik-tab" role="tabpanel"> 
                <?php include __DIR__ . '/f-akademik.php'; ?>
              </div>
