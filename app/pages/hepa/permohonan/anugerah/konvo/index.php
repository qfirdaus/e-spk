      ...
      <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm profile-card">
          ...
          <ul class="nav nav-tabs profile-tabs" role="tablist" aria-label="<?= h(tr('profile_tabs_label','Tab profil pengguna')) ?>">
            ...
            <!-- </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#khas-kecemerlangan-tab" role="tab">
                <i class="ri-user-line me-1"></i> <?= h(tr('tab_khas_kecemerlangan','Khas Kecemerlangan')) ?>
              </a>
            </li> -->
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#senarai-pencalonan-tab" role="tab">
                <i class="ri-user-line me-1"></i> <?= h(tr('tab_senarai_pencalonan','Senarai Akhir Pencalonan')) ?>
              </a>
            </li>
          </ul>
