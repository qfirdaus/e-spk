...
$allowedLayoutValues = ['light', 'dark']; // Layout mode hanya light/dark
$allowedColorValues = ['light', 'dark', 'brand']; // Topbar dan Sidebar boleh light/dark/brand
...
if ($sidebarColor !== '' && !in_array($sidebarColor, $allowedColorValues, true)) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Nilai sidebarColor tidak sah. Hanya "light", "dark", atau "brand" dibenarkan.'
    ], JSON_UNESCAPED_UNICODE);
    exit;
}
...
if ($topbarColor !== '' && !in_array($topbarColor, $allowedColorValues, true)) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Nilai topbarColor tidak sah. Hanya "light", "dark", atau "brand" dibenarkan.'
    ], JSON_UNESCAPED_UNICODE);
    exit;
}
